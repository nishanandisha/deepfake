"""Pre-populates the acoustic feature cache for every split.

Run once after building splits and before training. This front-loads the
expensive work (pitch tracking + spectral features) so training epochs
become I/O-bound instead of CPU-bound. Safe to interrupt and re-run --
