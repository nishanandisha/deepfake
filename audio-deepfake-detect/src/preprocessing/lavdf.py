...
the per-modality ground truth an audio-only detector must be scored
against -- a clip whose video was edited but whose audio is genuine is a
"real" example for this model, and LAV-DF is explicit about which is which.
